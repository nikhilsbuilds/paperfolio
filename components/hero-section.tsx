    ...
    <section className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[72px] font-bold leading-[85px]">
          ...
          <p className="text-[#393939] text-[18px] font-medium leading-[30px] max-w-xl">
          ...
          <div className="flex flex-wrap gap-7 pt-4">
            <Button className="bg-[#0B0B0B] text-white hover:bg-black/90 rounded-lg py-[22px] px-[62px] text-lg font-semibold h-auto min-w-[240px]">
              <Mail className="w-5 h-5" />
              Get in touch
            </Button>
            <Button
              variant="outline"
              className="bg-white border-[3px] border-black hover:bg-gray-50 rounded-lg py-[22px] px-[62px] text-lg font-semibold h-auto min-w-[240px]"
            >
